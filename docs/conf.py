...
latex_documents = [
  ('index', 'ploneappcaching.tex', u'plone.app.caching Documentation',
...
man_pages = [
    ('index', 'ploneappcaching', u'plone.app.caching Documentation',
...
texinfo_documents = [
  ('index', 'ploneappcaching', u'plone.app.caching Documentation',
   u'Plone Foundation', 'ploneappcaching', 'One line description of project.',
   'Miscellaneous'),
]
